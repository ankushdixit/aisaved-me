...
describe("Japanese Theme Footer Component", () => {
  ...
  describe("Newsletter Section", () => {
    ...
    it("renders newsletter description", () => {
      render(<Footer />);
      expect(screen.getByText("Weekly wins in your inbox")).toBeInTheDocument();
    });
  ...
  describe("Bottom Bar", () => {
    it("renders current year in copyright", () => {
      ...
      expect(screen.getByText(`© ${currentYear} AI Saved Me`)).toBeInTheDocument();
    });
  ...
  describe("Styling", () => {
    it("applies footer styling classes", () => {
      ...
      expect(footer).toHaveClass("bg-light-100", "text-dark-600", "border-t", "border-light-300");
    });

    it("applies font-mono class to section headers", () => {
      render(<Footer />);
      const storiesHeader = screen.getByText("STORIES");
      expect(storiesHeader).toHaveClass("font-mono");
    });
  });
